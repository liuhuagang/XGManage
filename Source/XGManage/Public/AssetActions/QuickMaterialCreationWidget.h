 ...
 */
UCLASS()
class XGMANAGE_API UQuickMaterialCreationWidget : public UEditorUtilityWidget
{
	GENERATED_BODY()
public:
...
#pragma endregion CreateMaterialNodesConnectPins
	...
	class UMaterialInstanceConstant* CreateMaterialInstanceAsset
	(UMaterial* CreatedMaterial, FString NameOfMaterialInstance,const FString& PathToPutMI);
};
